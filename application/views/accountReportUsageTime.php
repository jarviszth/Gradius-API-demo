...
?>
<title><?=MessageUtil::getMessage('app_report_accout_usage_detail')?></title>
<!-- START PAGE CONTENT -->
<div class="content">
    <!-- START JUMBOTRON -->
        ...
        <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
            <div class="inner">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="" class="active"><?=MessageUtil::getMessage('app_report_accout_usage_detail')?></a></li>
                </ul>
                <!-- END BREADCRUMB -->
            </div>
        </div>
    ...
    <div class="container-fluid container-fixed-lg">
        ...
        <div class="panel panel-default portlet-basic-v">
            <div class="panel-heading separator m-b-10">
                <div class="panel-title fs-16"><i class="fa fa-list"></i> <?=MessageUtil::getMessage('app_report_accout_usage_detail')?></div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="basicTable">
                        ...
                        <tr>
                            ...
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('acctstoptime','ASC')?>">
                                    Stop time
                                </a>
                                <span id="displaySort_acctstoptime"></i></span>
                            </th>
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('acctsessiontime','ASC')?>">
                                    Connection
                                    Duration (Hr.)
                                </a>
                                <span id="displaySort_acctsessiontime"></i></span>
                            </th>
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('nasportid','ASC')?>">
                                    NAS port
                                </a>
                                <span id="displaySort_nasportid"></i></span>
                            </th>
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('nasipaddress','ASC')?>">
                                    Nas IP
                                </a>
                                <span id="displaySort_nasipaddress"></i></span>
                            </th>
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('framedipaddress','ASC')?>">
                                    User IP
                                </a>
                                <span id="displaySort_framedipaddress"></i></span>
                            </th>
                            <th>
                                <a href="<?=ControllerUtil::uriSortConcat('acctterminatecause','ASC')?>">
                                    Terminate cause
                                </a>
                                <span id="displaySort_acctterminatecause"></i></span>
                            </th>
                        ...
                        if($reportList) {
                            foreach ($reportList AS $report) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p><?=$report['acctstarttime']?></p>
                                    </td>
                                    <td>
                                        <p><?=$report['acctstoptime']?></p>
                                    </td>
                                    <td>
                                        <p><?php
                                            $reportSumUsageTime = $report['acctsessiontime'];
                                            $usageReportTime = "Unused";
                                            if(!empty($reportSumUsageTime)){
                                                $usageReportInHors = DateUtils::secToHour($reportSumUsageTime);
                                                $usageReportTime= $usageReportInHors;
                                            }
                                            echo $usageReportTime;
                                            ?></p>
                                    </td>
                                    <td>
                                        <p><?=$report['nasportid']?></p>
                                    </td>
                                    <td>
                                        <p><?=$report['nasipaddress']?></p>
                                    </td>
                                    <td>
                                        <p><?=$report['framedipaddress']?></p>
                                    </td>
                                    <td>
                                        <p><?=$report['acctterminatecause']?></p>
                                    </td>
                                </tr>
