                ...
                <div class="view-port clearfix" id="chat">
                    <div class="view bg-white">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/1x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/1.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/1x.jpg" class="col-top">
                        </span>
                        </span>
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/2x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/2.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/2x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/3x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/3.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/3x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/4x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/4.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/5x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/5.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/5x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/6x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/6.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/6x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/7x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/7.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/7x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/8x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/8.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/8x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/9x.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/9.jpg" src="<?=__RESOURCES.'/'?>assets/img/profiles/9x.jpg" class="col-top">
                        </span>
                        </span>
                                            <p class="p-l-10 col-xs-height col-middle col-xs-12">
                        ...
                        <div class="chat-inner" id="my-conversation">
                            ...
                            <div class="message clearfix">
                                <div class="profile-img-wrapper m-t-5 inline">
                                    <img class="col-top" width="30" height="30" src="<?=__RESOURCES.'/'?>assets/img/profiles/avatar_small.jpg" alt="" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/avatar_small.jpg" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/avatar_small2x.jpg">
                                </div>
    ...
    <div class="overlay hide" data-pages="search">
        ...
        <div class="overlay-content has-results m-t-20">
            ...
            <div class="container-fluid">
                <!-- BEGIN Overlay Logo !-->
                <img class="overlay-brand" src="<?=__RESOURCES.'/'?>assets/img/logo.png" alt="logo" data-src="<?=__RESOURCES.'/'?>assets/img/logo.png" data-src-retina="<?=__RESOURCES.'/'?>assets/img/logo_2x.png" height="22">
                <!-- END Overlay Logo !-->
                <!-- BEGIN Overlay Close !-->
                <a href="javascript:void(0);" class="close-icon-light overlay-close text-black fs-16">
                    <i class="pg-close"></i>
                </a>
                <!-- END Overlay Close !-->
            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="">
                                ...
                                <div class="thumbnail-wrapper d48 circular bg-success text-white inline m-t-10">
                                    <div>
                                        <img width="50" height="50" src="<?=__RESOURCES.'/'?>assets/img/profiles/avatar.jpg" data-src="<?=__RESOURCES.'/'?>assets/img/profiles/avatar.jpg" data-src-retina="<?=__RESOURCES.'/'?>assets/img/profiles/avatar2x.jpg" alt="">
                                    </div>
                                </div>
