...
<!--                images Displayed are solely for representation purposes only, All work copyright of respective owner, otherwise © 2013-2014 REVOX.-->
    ...
    <div class="login-container bg-white">
        <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
            ...
            <!-- START Login Form -->
            <?php ControllerUtil::displayAppMsgBlock();?>
            <form id="form-login" name="login_form" class="p-t-15" role="form"  method="post">
                ...
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <input value="bekaku" type="text" name="email" id="email" placeholder="<?=MessageUtil::getMessage('model_app_user')?>" class="form-control" required>
                    </div>
                </div>
                <!-- END Form Control-->
                <!-- START Form Control-->
                <div class="form-group form-group-default">
                    ...
                    <div class="controls">
                        <input value="P@ssw0rd" name="password" id="password" type="password" class="form-control " <?=MessageUtil::getMessage('app_login_password')?> placeholder="<?=MessageUtil::getMessage('app_login_password')?>">
                    </div>
                </div>
                <!-- START Form Control-->
                <div class="row">
                ...
                <!-- END Form Control-->
                <input class="btn btn-primary btn-cons m-t-10" type="submit" onclick="formhash(this.form, this.form.password);" value="<?=MessageUtil::getMessage('app_login')?>"/>
            </form>
            <!--END Login Form-->
...
<!--                        <img alt="" class="m-t-5" data-src="--><?//=__RESOURCES.'/'?><!--assets/img/logo.png" data-src-retina="--><?//=__RESOURCES.'/'?><!--assets/img/logo_2x.png" height="42" src="--><?//=__RESOURCES.'/'?><!--assets/img/logo.png">-->
                    ...
                    <div class="col-sm-12 no-padding">
                        <p class="hint-text small">
                            &copy; <?=DateUtil::getYearNow()?> <?=MessageUtil::getMessage('app_system_name')?><br>
                            <a href="#">About</a>&nbsp;&nbsp;
                            <a href="#">Help</a>&nbsp;&nbsp;
                            <a href="#">Terms</a>&nbsp;&nbsp;
                            <a href="#">Privacy</a>&nbsp;&nbsp;
