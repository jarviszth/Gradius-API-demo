            ...
            <div class="panel panel-default portlet-basic-v">
                <div class="panel-heading separator m-b-10">
                    <div class="panel-title fs-16">
                        <i class="fa fa-pencil"></i> <?=MessageUtil::getMessage('app_form').' '.MessageUtil::getMessage('app_change_password')?>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <?php if(array_key_exists('confirmpwd', $errorsFiled)){echo "has-error";}?> ">
                            ...
                            <div class="col-sm-8"><input class="form-control" value="" type="password" name="confirmpwd" id="confirmpwd" ></div>
