...
<title><?=MessageUtil::getMessage('app_system_name')?> - System Error</title>
<body class="fixed-header error-page"><!-- menu-pin -->
<div class="container-xs-height full-height">
	<div class="row-xs-height">
		<div class="col-xs-height col-middle">
			<div class="error-container text-center">
				<h1 class="error-number">System Error</h1>
				<h2 class="semi-bold">
					<?php
						if (!empty($err_msg)) {
							echo $err_msg;
				...
				<p>This page is contain error from App <a href="#">Report this?</a>
				</p>
