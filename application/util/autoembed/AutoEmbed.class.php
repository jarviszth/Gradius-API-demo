 ...
 * http://autoembed.com
 *
 * $Id: AutoEmbed.class.php,v 1.1.1.1 2017/04/06 01:22:37 Chanavee Exp $
 *
...
class AutoEmbed {
  ...
  public function __construct() {
    ...
    include_once __SITE_PATH.'/application/util/autoembed/stubs.php';
/*
    foreach($AutoEmbed_stubs AS $rs){
      echoln('title='.$rs['title']);
    }
*/
    print_r($AutoEmbed_stubs);
  }
