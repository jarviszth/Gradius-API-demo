...
use application\util\phpexcelreader\Spreadsheet_Excel_Reader as Spreadsheet_Excel_Readers ;
/**
 ...
 */
 	class SpreadsheetReader_XLS implements Iterator, Countable
	{
		...
		public function __construct($Filepath, array $Options = null)
		{
			...
			$this -> Handle = new Spreadsheet_Excel_Readers($Filepath, false, 'UTF-8');
